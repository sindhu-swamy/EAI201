...
# Suppressing the FutureWarning for inplace=True by using the non-inplace method
...
# Average Age Merge 1 (FIXED TYPO: drop(columns=['Country_Name']))
...
# Average Age Merge 2 (FIXED TYPO: drop(columns=['Country_Name']))
